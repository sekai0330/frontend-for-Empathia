    ...
    datasets: [
      {
        ...
        backgroundColor: ["red", "#d1b5bb"],
      },
    ],

    labels: ["Score: " + UserData[0]],
  };

  return (
    <div style={styles.resultsContainer}>
      <div style={styles.resultsBoxContainer} className="resultsBoxContainer">
        <div style={styles.graphContainer} className="graphResult">
          <Doughnut data={data} />
        </div>
        <div
          style={styles.transcriptConatiner}
          className="scroll transcriptResult"
        >
          {UserData[2]}
        </div>
      </div>
      ...
      <div>Feedback</div>
      <div style={styles.feedbackContainer} className="scroll">
        {UserData[1]}
      </div>
    </div>
  );
